...
if ( ! function_exists( 'wpex_add_gallery_metabox' ) ) {
	function wpex_add_gallery_metabox() {
		add_meta_box( 'easy_image_gallery', __( 'Image Gallery', 'office' ), 'wpex_gallery_metabox', 'portfolio', 'normal', 'high' );
	}
}
...
function wpex_gallery_metabox() {
				...
				foreach ( $attachments as $attachment_id ) {
					if ( wp_attachment_is_image ( $attachment_id  ) ) {
						echo '<li class="image" data-attachment_id="' . $attachment_id . '"><div class="attachment-preview"><div class="thumbnail">
									...
									<a href="#" class="wpex-gmb-remove" title="' . __( 'Remove image', 'office' ) . '"><div class="media-modal-icon"></div></a>
								</div></li>';
					}
				}
			} ?>
	...
	<p class="add_gallery_images hide-if-no-js">
		<a href="#" class="button-secondary"><?php _e( 'Add/Edit Images', 'office' ); ?></a>
	</p>
	<?php
	...
	<p>
		<label for="easy_image_gallery_link_images">
			<input type="checkbox" id="easy_image_gallery_link_images" value="on" name="easy_image_gallery_link_images"<?php echo $checked; ?> /> <?php _e( 'Enable Lightbox for this gallery?', 'office' )?>
		</label>
	</p>
		...
		jQuery(document).ready(function($){
			...
			jQuery('.add_gallery_images').on( 'click', 'a', function( event ) {
				...
				image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
					...
					title: '<?php _e( 'Add Images to Gallery', 'office' ); ?>',
					button: {
						text: '<?php _e( 'Add to gallery', 'office' ); ?>',
					},
					multiple: true
				});
							 ...
							 $gallery_images.append('\
								<li class="image" data-attachment_id="' + attachment.id + '">\
									<div class="attachment-preview">\
									   ...
									   <a href="#" class="wpex-gmb-remove" title="<?php _e( 'Remove image', 'office' ); ?>"><div class="media-modal-icon"></div></a>\
									</div>\
								</li>');
						}
					} );
