...
if ( !function_exists('wpex_load_google_fonts') ) {
	...
	function wpex_load_google_fonts() {
		...
		// Body
		$body_font = wpex_get_data('body_gfont','default');
		...
		// Headings
		$headings_font = wpex_get_data('headings_gfont','default');
		...
		// Callout
		$logo_font = wpex_get_data('callout_gfont','default');
		if ( $logo_font !== 'default' ) {
			$output_stylesheets .= "<link href='http://fonts.googleapis.com/css?family=$logo_font' rel='stylesheet' type='text/css'>";
			$output_css .= "a#top-bar-callout { font-family:'$logo_font'; }";
		}
		...
		if ( $logo_font !== 'default' ) {
			$output_stylesheets .= "<link href='http://fonts.googleapis.com/css?family=$logo_font' rel='stylesheet' type='text/css'>";
			$output_css .= ".logo h1,.logo h2{font-family:'$logo_font'; }";
		}
		
		// Menu
		$menu_font = wpex_get_data('navigation_gfont','default');
		if ( $menu_font !== 'default' ) {
			...
			$output_css .= "#navigation {font-family:'$menu_font'; }";
		}
		
		// Tagline
		$menu_font = wpex_get_data('tagline_gfont','default');
		if ( $menu_font !== 'default' ) {
			$output_stylesheets .= "<link href='http://fonts.googleapis.com/css?family=$menu_font' rel='stylesheet' type='text/css'>";
			$output_css .= "#home-tagline {font-family:'$menu_font'; }";
		}
